...
@section('main-section')
    ...
    <body
        style="background-image: url('{{ asset('assets/images/loginbacktwo.jpg') }}'); background-repeat:no-repeat; background-size:cover;background-position-x: -297px">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="p-lg-5 p-4">
                                            <div class="">
                                                ...
                                                <p class="text-dark text-center">Sign in to continue</p>
                                            </div>
                                            <div class="mt-4">
                                                ...
                                                <form action="{{ route('verifteamyotp') }}" method="POST"
                                                    id="otpsignupform" style="display: none;">
                                                    @csrf
                                                    <div class="p-lg-5 p-4">
