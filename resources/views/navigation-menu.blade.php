...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="{{ route('dashboard') }}" class="logo logo-dark">
            <span class="logo-sm">
                <img src="{{ asset('assets/images/A.png') }}" alt="" height="30" />
                {{-- <h3 class="fs-3 pt-3 pb-3">ASI</h3> --}}
            </span>
            <span class="logo-lg">
                <img src="{{ asset('assets/images/logofinal.png') }}" alt="" height="30" />
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{route('viewsubmaster')}}">
                        <i class="bx bx-add-to-queue"></i>
                        <span>Add Submaster</span>
                    </a>
                </li>
                {{-- <li class="menu-title">
